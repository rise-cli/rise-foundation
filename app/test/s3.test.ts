import getFile from '../src/s3/get_file'
import uploadFile from '../src/s3/upload_file'
import removeFile from '../src/s3/remove_file'
import * as fs from 'fs'
import makeBucket from '../src/s3/cf/bucket'
import makeSimpleBucket from '../src/s3/cf/makeSimpleBucket'
